  ...
  return (
    <div className="w-full flex flex-col gap-1">
      ...
      <div className="flex flex-col min-[400px]:flex-row items-center gap-2 w-full">
        ...
        <button
          type="button"
          className="text-orange-500 font-bold text-[13px] flex flex-row gap-2 items-center justify-center cursor-pointer px-3 py-1.5 border border-orange-500 rounded shrink-0 whitespace-nowrap bg-white"
        >
