      ...
      <div className="w-full h-18 flex flex-row items-center justify-between px-4 md:px-8 xl:px-16">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden sm:flex flex-col">
            ...
            <span className="text-[#ea580c] text-[10px] font-bold tracking-wider">DVO / SMA</span>
          </div>
        </div>

        <div className="flex flex-row items-center gap-6">
          <div className="flex flex-col text-right">
            <span className="text-white text-sm font-semibold">Auto Peças Pelotas Ltda</span>
